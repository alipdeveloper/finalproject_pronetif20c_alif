...
namespace KasirVape
{
    class H
    {
        ...
        public static bool isKdExist(string kode = "", string table = "tb_barang", string field = "kode_barang", string exclude="")
        {
        ...
        //public static void FillCmbSup(ComboBox cmb, string id_supplier = "nama", string selected = "", bool allowEmpty = false)
        //{
         //   dr = OpenDr("SELECT id_supplier FROM tb_supplier WHERE nama='" + id_supplier + "' ORDER BY id_supplier");
         //   FillCmb(dr, cmb, selected, allowEmpty);
        //}
    }
}
